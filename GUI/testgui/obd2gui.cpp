		...
		for(int quadrant=0;quadrant<4;quadrant++)
		{
			...
			switch((int)control[quadrant] - 48) // Minus 48 to switch from ASCII that is returned
			{
				case 1: 
				{
					...
					string speedText = intToString(speed) + speedUnit;
					...
					break;
                                ...
                                case 2:
                                {
                                        ...
                                        string efficText = intToString(effic) + efficUnit;
                                ...
                                case 3:
                                {
                                        ...
                                        string rpmText = intToString(rpm) + rpmUnit;
                                ...
                                case 4:
                                {
                                        string rearDistText = intToString(rearDist) + rearDistUnit;
                                ...
                                case 5:
                                {
                                        string tempText = intToString(temp) + tempUnit;
                                ...
                                case 6:
                                {
                                        //string speedText = intToString(speed);
